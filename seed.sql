...
(32,'Vin Rosé','Boissons',5,'public/images/nourriture/vin_rose.png','Côte de Provence (Verre 12cl / Bouteille)','[{\"titre\":\"Format\",\"choix\":[\"Verre 12cl - 5.00 €\",\"Bouteille - 24.00 €\"]}]'),
...
(46,'Menu Mystère','Menus',35.0,'/public/images/nourriture/mystery.png','Laissez-vous surprendre ! Une entrée, un plat, un dessert et une boisson sélectionnés au hasard.','[]');
